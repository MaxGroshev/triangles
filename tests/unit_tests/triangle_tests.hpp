...
class triangle_test : public ::testing::Test {
    protected:
        ...
        point_t p1 {0, 0, 4}; //probably make static
        point_t p2 {0, 5, 0};
        point_t p3 {4, 0, 0};
...
//-----------------------------------------------------------------------------------------
TEST_F(triangle_test, point_in_triangle_2d) {
    point_t t_p4(-3, 0, 0);
    //triangle.print();
...
// }
//
// TEST_F(triangle_test, point_out_triangle_2d) {
...
// }
//
// TEST_F(triangle_test, point_on_triangle_2d) {
//     point_t t_p4(0, 0, 0);
//     point_t t_p5(0, 1, 0);
//     point_t t_p6(1, 0, 0);
